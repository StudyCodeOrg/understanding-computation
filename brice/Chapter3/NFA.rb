...
class NFARunner < Struct.new(:start_states, :accept_states, :rulebook)
  def nfa
...
if __FILE__ == $0
  ...
  context "ε-NFA" do
    asserts "will take into account free moves when getting current states" do
      nfa = NFA.new([1], [4], NFARulebook.new([
        FARule.new(1,nil,2),
        FARule.new(2,nil,3),
        FARule.new(3,nil,4)
      ]))
